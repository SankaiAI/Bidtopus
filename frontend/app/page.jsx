      ...
      <Wrap>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72 }}>
          ...
          <div className="bt-nav-right" style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <a
              href="https://github.com/SankaiAI/Bidtopus"
              target="_blank"
              rel="noopener noreferrer"
              title="View source on GitHub"
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 36, height: 36, borderRadius: 8, color: S.charcoal, textDecoration: 'none', transition: 'background 150ms ease, color 150ms ease' }}
              onMouseEnter={e => { e.currentTarget.style.background = S.surface; e.currentTarget.style.color = S.ink }}
              onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = S.charcoal }}
            >
        ...
        {open && (
          <div className="bt-mobile-menu" style={{ borderTop: `1px solid ${S.hairline}`, padding: '16px 0 20px', display: 'flex', flexDirection: 'column', gap: 4 }}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 4px', color: S.charcoal, textDecoration: 'none', font: `500 14px/1 ${S.fontSans}` }}
            >
